...
class CoachHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String coachId = currentUser?.email ?? '';
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Container(
            ...
            child: const Text('Coach Home',
                style: TextStyle(
                    fontSize: 23,
                    color: Color.fromARGB(255, 11, 136, 27),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: TabBar(
                        ...
                        labelColor: const Color.fromARGB(255, 5, 154,
                            22), // Change the selected tab text color
        ...
        body: Padding(
          ...
          child: TabBarView(
            children: [
              _buildUpcomingRequests(context, coachId),
              _buildAcceptedRequests(context, coachId),
            ],
          ),
        ),
      ),
  ...
  Widget _buildUpcomingRequests(BuildContext context, String coachId) {
  ...
  Widget _buildAcceptedRequests(BuildContext context, String coachId) {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      stream: FirebaseFirestore.instance
          .collection('BookingRequests')
          .where('coachId', isEqualTo: coachId)
  ...
  void _removeCustomer(BuildContext context, String requestId) {
    ...
    FirebaseFirestore.instance
        .collection('BookingRequests')
        .doc(requestId)
        .update({'status': 'removed by coach'}).then((_) {
