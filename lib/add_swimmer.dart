...
class AddSwimmerPage extends StatefulWidget {
  ...
  @override
   _AddSwimmerPageState createState() {
    return _AddSwimmerPageState();
  }
}
...
class _AddSwimmerPageState extends State<AddSwimmerPage> {
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Tip about the Swimmer',
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.all(Radius.circular(8.0)),
                  ),
                  focusedBorder: OutlineInputBorder(
  ...
  Future<void> _submitForm() async {
    ...
    final swimmersSnapshot = await FirebaseFirestore.instance
        .collection('swimmers')
        .where('name', isEqualTo: name)
        .get();

    if (swimmersSnapshot.docs.isNotEmpty) {
      _showErrorDialog('A swimmer with the same name already exists');
      return;
    }
    ...
    if (swimmerName != null) {
      ...
      final swimmerId = FirebaseFirestore.instance.collection('swimmers').doc().id;
      ...
      await FirebaseFirestore.instance
          .collection('swimmers')
          .doc(swimmerId) // Use swimmerId as the document ID
          .set(swimmerData);
    }
